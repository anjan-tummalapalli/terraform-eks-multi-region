...
# Data Purpose: Reads data source aws_iam_policy_document.eks_assume_role to
...
# policy to a role (aws_iam_role_policy_attachment.eks_cluster_policy).
...
# Resource Purpose: Attaches a managed Identity and Access Management (IAM)
# policy to a role (aws_iam_role_policy_attachment.eks_vpc_controller_policy).
resource "aws_iam_role_policy_attachment" "eks_vpc_controller_policy" {
  role       = aws_iam_role.eks_cluster.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonEKSVPCResourceController"
}

# Data Purpose: Reads data source aws_iam_policy_document.node_assume_role to
# fetch existing Amazon Web Services (AWS) context required by dependent
# expressions.
...
# Resource Purpose: Attaches a managed Identity and Access Management (IAM)
# policy to a role (aws_iam_role_policy_attachment.worker_node_policy).
...
# Resource Purpose: Attaches a managed Identity and Access Management (IAM)
# policy to a role (aws_iam_role_policy_attachment.cni_policy).
...
# Resource Purpose: Attaches a managed Identity and Access Management (IAM)
# policy to a role (aws_iam_role_policy_attachment.ecr_read_only_policy).
