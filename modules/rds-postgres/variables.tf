...
# Purpose:
#   Declares input interface for module 'rds-postgres' (types, defaults,
# validation).
...
# Variable Purpose: Name prefix for Relational Database Service (RDS) resources.
variable "name" {
...
# Variable Purpose: PostgreSQL engine version.
